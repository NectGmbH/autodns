...
func (o *DomainCommentUpdateParams) WithXDomainrobotContext(xDomainrobotContext *string) *DomainCommentUpdateParams {
...
func (o *DomainCommentUpdateParams) SetXDomainrobotContext(xDomainrobotContext *string) {
...
func (o *DomainCommentUpdateParams) WithXDomainrobotDemo(xDomainrobotDemo *string) *DomainCommentUpdateParams {
	o.SetXDomainrobotDemo(xDomainrobotDemo)
	return o
}

// SetXDomainrobotDemo adds the xDomainrobotDemo to the domain comment update params
func (o *DomainCommentUpdateParams) SetXDomainrobotDemo(xDomainrobotDemo *string) {
...
func (o *DomainCommentUpdateParams) WithXDomainrobotOwnerContext(xDomainrobotOwnerContext *string) *DomainCommentUpdateParams {
...
func (o *DomainCommentUpdateParams) SetXDomainrobotOwnerContext(xDomainrobotOwnerContext *string) {
...
// WithXDomainrobotPIN adds the xDomainrobotPIN to the domain comment update params
func (o *DomainCommentUpdateParams) WithXDomainrobotPIN(xDomainrobotPIN *string) *DomainCommentUpdateParams {
	o.SetXDomainrobotPIN(xDomainrobotPIN)
	return o
}

// SetXDomainrobotPIN adds the xDomainrobotPIN to the domain comment update params
func (o *DomainCommentUpdateParams) SetXDomainrobotPIN(xDomainrobotPIN *string) {
