...
/*SubscriptionUpdateOK handles this case with default header values.
...
func (o *SubscriptionUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /subscription/{contractId}][%d] subscriptionUpdateOK  %+v", 200, o.Payload)
}
