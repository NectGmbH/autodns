...
func (m *MailProxy) validateBannedFilesEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, mailProxyTypeBannedFilesPropEnum); err != nil {
		return err
	}
	return nil
}
...
func (m *MailProxy) validateHeaderEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, mailProxyTypeHeaderPropEnum); err != nil {
		return err
	}
	return nil
}
...
func (m *MailProxy) validateVirusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, mailProxyTypeVirusPropEnum); err != nil {
		return err
	}
	return nil
}
