...
// swagger:model initial_claims
type InitialClaims struct {
...
// Validate validates this initial claims
func (m *InitialClaims) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InitialClaims) validateAddress(formats strfmt.Registry) error {
...
func (m *InitialClaims) validateBirthdate(formats strfmt.Registry) error {
...
func (m *InitialClaims) validateGender(formats strfmt.Registry) error {
...
func (m *InitialClaims) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InitialClaims) UnmarshalBinary(b []byte) error {
	var res InitialClaims
