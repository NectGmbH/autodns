...
type DomainRestore struct {
	...
	// Enable auto dnssec for the domain.
	...
	IncludeWildcard bool `json:"includeWildcard,omitempty"`
	...
	NsCheck DNSCheck `json:"nsCheck,omitempty"`
...
func (m *DomainRestore) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAutodnsSecJob(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateNsCheck(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DomainRestore) validateAutodnsSecJob(formats strfmt.Registry) error {

	if swag.IsZero(m.AutodnsSecJob) { // not required
		return nil
	}

	if m.AutodnsSecJob != nil {
		if err := m.AutodnsSecJob.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("autodnsSecJob")
			}
			return err
		}
	}
...
func (m *DomainRestore) validateNsCheck(formats strfmt.Registry) error {

	if swag.IsZero(m.NsCheck) { // not required
		return nil
	}

	if err := m.NsCheck.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("nsCheck")
		}
		return err
	}
