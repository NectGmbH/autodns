...
type BasicCustomer struct {
	...
	// The customers sepa mandate if payament aws post with sepa.
...
func (m *BasicCustomer) validateAddressLines(formats strfmt.Registry) error {
	...
	if err := validate.MaxItems("addressLines", "body", iAddressLinesSize, 9999); err != nil {
		return err
	}
...
func (m *BasicCustomer) validateCity(formats strfmt.Registry) error {
...
func (m *BasicCustomer) validateEmails(formats strfmt.Registry) error {
	...
	if err := validate.MaxItems("emails", "body", iEmailsSize, 9999); err != nil {
		return err
	}
...
func (m *BasicCustomer) validatePcode(formats strfmt.Registry) error {
